...
W='\033[0m'
# The Credit For This Code Goes To Mr.Potter And All Other Contributors Listed At https://github.com/TheSpeedX/TBomb
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("              This Bomber Was Created By Mr.Potter (Anas) !!                ")
        print("==================================================================")
        try:
